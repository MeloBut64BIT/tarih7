...
const translations = {
  tr: {
    app: { title: 'Tarihte Bugün' },
    header: { appName: 'Tarihte Bugün', menu: 'Menü', search: 'Ara' },
    menu: {
      title: 'Menü',
      close: 'Menüyü Kapat',
      about: 'Hakkımızda',
    ...
    footer: { copyright: "Tüm hakları Leblebi Soft'a aittir" },
    date: {
  ...
  en: {
    ...
    header: { appName: 'Today in History', menu: 'Menu', search: 'Search' },
    menu: {
      title: 'Menu',
      close: 'Close Menu',
      about: 'About',
    ...
    footer: { copyright: 'All rights reserved by Leblebi Soft' },
    date: {
  ...
  useEffect(() => {
    const loadLanguage = async () => {
      try {
        ...
        setLanguageState(browserLang.toLowerCase().startsWith('tr') ? 'tr' : 'en')
      } catch {
        setLanguageState('tr')
      }
    }
